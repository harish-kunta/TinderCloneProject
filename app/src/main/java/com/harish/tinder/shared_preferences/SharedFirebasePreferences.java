package com.harish.tinder.shared_preferences;
...
public class SharedFirebasePreferences implements SharedPreferences {
     ...
     */
    private static String sPathPattern = String.format(Locale.ENGLISH, "/Users/%s", UID_PLACEHOLDER);
    ...
    public static class Editor implements SharedPreferences.Editor {
        ...
        /**
         * The {@link SharedPreferences.Editor} handling the edit process
         */
