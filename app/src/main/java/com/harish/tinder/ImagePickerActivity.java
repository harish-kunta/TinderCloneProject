...
public class ImagePickerActivity extends AppCompatActivity implements ImagePickerAdapter.OnRecyclerViewItemClickListener {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        switch (position) {
                            ...
                            case 1:
                                //Open the selection, the number of choices allowed this time
                                ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                                Intent intent1 = new Intent(getApplicationContext(), ImageGridActivity.class);
