...
import static com.harish.tinder.model.Constants.TERMS_AGREED;
...
public class HouseRulesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUserDatabase = FirebaseDatabase.getInstance().getReference().child(Constants.USERS).child(current_uid);
